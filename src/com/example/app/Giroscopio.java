...
public class Giroscopio extends Activity implements 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		infogiroscopio = (Button) findViewById(R.id.infogiroscopio);
		...
		grafica.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View boton) {
				// TODO Auto-generated method stub
				Intent graficas = new Intent(Giroscopio.this, Grafica.class);
		...
		//Declaración del botón informacion
				infogiroscopio.setOnClickListener(new OnClickListener() {
					
					@Override
					public void onClick(View boton) {
						// TODO Auto-generated method stub
						Intent info = new Intent(Giroscopio.this, DefinicionGiroscopio.class);
						startActivity(info);
					}
				});
