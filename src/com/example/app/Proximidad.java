...
public class Proximidad extends Activity implements 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		infoproximidad = (Button) findViewById(R.id.infoproximidad);
		/*/Recogemos el tiempo
		...
		grafica.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View boton) {
				// TODO Auto-generated method stub
				Intent graficas = new Intent(Proximidad.this, Grafica.class);
		...
		infoproximidad.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View boton) {
				// TODO Auto-generated method stub
				Intent info = new Intent(Proximidad.this, DefinicionProximidad.class);
				startActivity(info);
			}
		});
