...
public class Luz extends Activity implements 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		infoluz = (Button) findViewById(R.id.infoluz);
		/*/Recogemos el tiempo
		...
		grafica.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View boton) {
				// TODO Auto-generated method stub
				Intent graficas = new Intent(Luz.this, Grafica.class);
		...
		infoluz.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View boton) {
				// TODO Auto-generated method stub
				Intent info = new Intent(Luz.this, DefinicionLuz.class);
				startActivity(info);
			}
		});
